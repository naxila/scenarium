    ...
    await this.withInterpolationContext(
      ...
      async (interpolationContext) => {
        ...
        console.log('🔍 UpdateMessage DEBUG - Final text analysis:', {
          ...
          originalTextType: typeof action.text,
          interpolatedTextType: typeof interpolatedAction.text,
          hasMessageIdInOriginal: typeof action.text === 'string' ? action.text.includes('{{messageId}}') : 'N/A (not string)',
          hasMessageIdInInterpolated: typeof interpolatedAction.text === 'string' ? interpolatedAction.text.includes('{{messageId}}') : 'N/A (not string)',
